  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gray-50 rounded-sm'>
      ...
      <form onSubmit={onSubmitHandler} className='bg-white p-8 rounded-lg shadow-lg w-96 text-sm'>
        <h1 className='text-gray-700 text-2xl font-semibold text-center mb-4'>Email Verify OTP</h1>
        ...
        <button type='submit' className='w-full py-3 bg-gradient-to-r from-gray-500 to-gray-900 text-white rounded-full'>Verify Email</button>
      </form>
    </div>
  )
}
