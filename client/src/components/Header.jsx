...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Welcome to myAuth Authentication System</h2>

      <p className='mb-8 max-w-md'>Let's start with a quick tour and explore the different sections of the app!</p>
